...
namespace SuperMyCadoApi.Controllers
{
    ...
    public class ProdutoController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ProdutoDTO>>> GetProdutos()
        {
            ...
            return await _context.Produtos.Include(x => x.NomeLojaProduto).Include(s => s.SiglaGamaProduto).Select(x => ProdutoToDTO(x)).ToListAsync();
        }
        ...
        public async Task<ActionResult<ProdutoDTO>> GetProduto(long id)
        {
            ...
            var produto = await _context.Produtos.Include(x => x.NomeLojaProduto).Include(s => s.SiglaGamaProduto).Where(x => x.ProdutoId == id).FirstOrDefaultAsync();
        ...
        public async Task<ActionResult<ProdutoDTO>> GetProduto(string cod)
        {
            ...
            var produto = await _context.Produtos.Include(x => x.NomeLojaProduto).Include(s => s.SiglaGamaProduto).Where(x => x.CodigoProduto == cod).FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> PutProduto(long id, ProdutoDTO produtodto)
        {
            ...
            produto.NomeLojaProduto = loja;
            produto.SiglaGamaProduto = gama;
        ...
        public async Task<ActionResult<Produto>> PostProduto(ProdutoDTO produtodto)
        {
            ...
            var produto = new Produto
            {
                ...
                NomeLojaProduto = loja,
                SiglaGamaProduto = gama
            };
        ...
        private static ProdutoDTO ProdutoToDTO(Produto produto)
        {
            ProdutoDTO dto = new ProdutoDTO
            {
                ...
                NomeLojaProduto = produto.NomeLojaProduto?.NomeLoja,
                SiglaGamaProduto = produto.SiglaGamaProduto?.SiglaGama
            };
            return dto;
        }
    }
