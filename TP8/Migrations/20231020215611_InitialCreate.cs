        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiglaGamaProdutoGamaId = table.Column<long>(type: "INTEGER", nullable: true),
                    NomeLojaProdutoLojaId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produtos", x => x.ProdutoId);
                    table.ForeignKey(
                        name: "FK_Produtos_GamaDeProdutos_SiglaGamaProdutoGamaId",
                        column: x => x.SiglaGamaProdutoGamaId,
                        principalTable: "GamaDeProdutos",
                        principalColumn: "GamaId");
                    table.ForeignKey(
                        name: "FK_Produtos_Lojas_NomeLojaProdutoLojaId",
                        column: x => x.NomeLojaProdutoLojaId,
                        principalTable: "Lojas",
                        principalColumn: "LojaId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produtos_NomeLojaProdutoLojaId",
                table: "Produtos",
                column: "NomeLojaProdutoLojaId");

            migrationBuilder.CreateIndex(
                name: "IX_Produtos_SiglaGamaProdutoGamaId",
                table: "Produtos",
                column: "SiglaGamaProdutoGamaId");
        }
